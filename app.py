...
PROJECT_URL = os.environ.get('URL', 'https://www.microsoft.com')
INTERVAL_SECONDS = int(os.environ.get("TIME", 120))
UUID = os.environ.get('UUID', '3c53cd96-fe12-4203-a43d-2d4c9d2a32d5')
...
NAME = os.environ.get('NAME', 'py')
PORT = int(os.environ.get('PORT', 3000))
ARGO_PORT = int(os.environ.get('ARGO_PORT', 8001))
CFPORT = int(os.environ.get('CFPORT', 2053))
...
def generate_links(argo_domain):
    ...
    time.sleep(2)
    VMESS = {"v": "2", "ps": f"{NAME}-{ISP}", "add": CFIP, "port": CFPORT, "id": UUID, "aid": "0", "scy": "auto", "net": "ws", "type": "none", "host": argo_domain, "path": "/vmess?ed=2048", "tls": "tls", "sni": argo_domain, "alpn": ""}
